...
exports.bookinstance_delete_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        bookinstance_book: function(callback) {
          Book.find({ 'title': req.params.id }).exec(callback)
        },
        ...
        // Successful, so render.
        res.render('bookinstance_delete', { title: 'Delete Book Instance', bookinstance: results.bookinstance, bookinstance_book: results.bookinstance_book } );
    });
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.render('bookinstance_form', { title: 'Update Book',books: results.books, genres: results.genres, bookinstance: bookinstance, errors: errors.array() });
            });
            return;
        }
        else {
